...
export default function RegisterTeacherPage() {
  ...
  const qualificationOptions = ["BS", "MS", "MPhil", "PhD", "Post Doctorate"];
      ...
      <div className="w-full max-w-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Create your faculty account for the FYP Automation System
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-100 p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 mt-1">
                Must be a valid @nu.edu.pk email address
              </p>
            </div>
          ...
          <p className="mt-4 text-center text-sm text-gray-500">
            ...
            <Link
              href="/login"
              className="text-[#3F51B5] hover:text-[#5C6BC0] font-medium"
            >
              Sign In
            </Link>
          </p>
