...
export default function LoginPage() {
  ...
  const validateEmail = (email: string): boolean => {
    ...
    if (!trimmedEmail.endsWith('@nu.edu.pk')) return false;
    const usernamePart = trimmedEmail.split('@')[0];
    if (!usernamePart || usernamePart.length === 0) return false;
    return true;
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-100 p-6">
          ...
          {/* ============================================ */}
          {/* REGISTRATION LINKS - ONLY SHOW ON RELEVANT TAB */}
          {/* ============================================ */}
          <div className="mt-6 space-y-3">
            {/* ✅ Student Group Registration - ONLY when student tab is active */}
            {activeRole === 'student' && (
              <p className="text-center text-sm text-gray-500">
                Don't have a student group account?{' '}
            ...
            {/* ✅ Teacher Registration - ONLY when teacher tab is active */}
            {activeRole === 'teacher' && (
              <div>
                <p className="text-center text-sm text-gray-500">
                  Are you a faculty member?{' '}
                  <Link href="/register-teacher" className="text-[#3F51B5] hover:text-[#5C6BC0] font-medium">
                    Register as Teacher
                  </Link>
                </p>
